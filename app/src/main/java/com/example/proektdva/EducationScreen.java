...
public class EducationScreen extends AppCompatActivity {
                ...
                new SwipeListViewTouchListener(
                        ...
                        new SwipeListViewTouchListener.OnSwipeCallback() {
                            ...
                            public void onSwipeLeft(ListView listView, int[] reverseSortedPositions) {
                                Intent i = new Intent(EducationScreen.this, MainActivity.class);
                                startActivity(i);
                            }
                            @Override
                            public void onSwipeRight(ListView listView, int[] reverseSortedPositions) {
                                Intent i = new Intent(EducationScreen.this, IndustryScreen.class);
                                startActivity(i);
                            }
                        },
    ...
    public void search(){
        ...
        theFilter.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (EducationScreen.this).myAdapter.getFilter().filter(s);
            }
            @Override
    ...
    public void loadDataInListView(){
        arrayList = databaseHelper.getDataEducation();
