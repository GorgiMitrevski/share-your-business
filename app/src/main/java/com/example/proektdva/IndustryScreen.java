...
//////////////
                ...
                new SwipeListViewTouchListener(
                        ...
                        new SwipeListViewTouchListener.OnSwipeCallback() {
                            ...
                            public void onSwipeLeft(ListView listView, int[] reverseSortedPositions) {
                                Intent i = new Intent(IndustryScreen.this, EducationScreen.class);
                                startActivity(i);
                            }
                            @Override
                            public void onSwipeRight(ListView listView, int[] reverseSortedPositions) {
                                Intent i = new Intent(IndustryScreen.this, FunScreen.class);
                                startActivity(i);
                            }
                        },
    ...
    public void search(){
        ...
        theFilter.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (IndustryScreen.this).myAdapter.getFilter().filter(s);
            }
            @Override
    ...
    public void loadDataInListView(){
        arrayList = databaseHelper.getDataIndustry();
